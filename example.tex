...
\setadvisor{Pretitle}{Forename Surname}{Posttitle}{female}
...
\setcurriculum{Telecommunications}{Telecommunications} % Sets the English and German name of the curriculum.
